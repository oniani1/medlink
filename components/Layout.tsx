...
export const PhoneFrame = ({ children }: { children?: React.ReactNode }) => (
  <div className="h-full bg-slate-100 sm:flex sm:items-center sm:justify-center sm:p-4 overflow-hidden">
    <div className="w-full sm:max-w-[390px] h-full sm:h-[844px] bg-white sm:rounded-[3rem] sm:border-[8px] sm:border-slate-900 sm:shadow-2xl overflow-hidden relative flex flex-col">
